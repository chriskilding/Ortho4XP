            ...
            runway_pol = geometry.Polygon(
                numpy.round(
                    numpy.array(
                        [
                            airport_layer.dicosmn[nodeid]
                            for nodeid in airport_layer.dicosmr[relid][
                                "outer"
                            ][0]
                        ]
                    )
    ...
    airport_list = (
        sorted(
            [
                ...
                if dico_airports[x]["key_type"] == "icao"
            ]
        )
        + sorted(
            [
                x
                for x in dico_airports
                if dico_airports[x]["key_type"] == "iata"
            ]
        )
        + sorted(
            [
        ...
        + sorted(
            [
                x
                for x in dico_airports
                if dico_airports[x]["key_type"] == "name"
            ]
        )
        + sorted(
            [
